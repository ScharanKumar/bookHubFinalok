...
class Currentlyreadingbooks extends Component{
    ...
    after=async(s)=>{
        ...
        const response=await fetch(`https://apis.ccbp.in/book-hub/books?shelf=CURRENTLY_READING&search=${s}`,option)
        ...
        return(
            <div className="allbooksCon1">
                ...
                <div className="allbooksCon2">
                    <Leftheader all="false" read="false" wanttoread="false" currentlyreading="true"/>
                     <div className="allbooksCon3">
                        <div className="allbooksCon4">
                            <h1 className="headok">Currently Reading Books</h1>
